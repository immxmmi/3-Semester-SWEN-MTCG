...
public class PlayerRepositoryImpl extends AbstractDBTable implements PlayerRepository {
    ...
    private ProfilRepository playerInfoService;
    private StackRepository stackService;
    private DeckRepository deckService;
    ...
    /*******************************************************************/
    @Override
    public PlayerRepositoryImpl getInstance() {
        if (PlayerRepositoryImpl.instance == null) {
            PlayerRepositoryImpl.instance = new PlayerRepositoryImpl();
        }
        return PlayerRepositoryImpl.instance;
    }
