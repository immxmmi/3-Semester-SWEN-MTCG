...
public class CardHolderRepositoryImpl extends AbstractDBTable implements CardHolderRepository {

    private static CardHolderRepositoryImpl instance;

    /*******************************************************************/
    /**                          Constructor                          **/
    /*******************************************************************/
    public CardHolderRepositoryImpl() {
    ...
    public void sellPackage(String packageID, String new_holderID) {
        ...
        PackageRepository packageService = new PackageRepositoryImpl();
...
//        System.out.println("DELETE HOLDER:");
    ...
    @Override
    public CardHolderRepositoryImpl getInstance() {
        if (CardHolderRepositoryImpl.instance == null) {
            CardHolderRepositoryImpl.instance = new CardHolderRepositoryImpl();
        }
        return CardHolderRepositoryImpl.instance;
    }
