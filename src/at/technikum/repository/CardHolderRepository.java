...
import at.technikum.model.ICardHolder;
...
public class CardHolderRepository extends AbstractDBTable implements ICardHolderRepository {

    private static CardHolderRepository instance;
...
//        System.out.println("DELETE HOLDER:");
    ...
    @Override
    public CardHolderRepository getInstance() {
        if (CardHolderRepository.instance == null) {
            CardHolderRepository.instance = new CardHolderRepository();
        }
        return CardHolderRepository.instance;
    }
